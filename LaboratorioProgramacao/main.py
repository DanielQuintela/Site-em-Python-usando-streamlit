...
if paginaSelecionada == 'Tela de inicio':
    ...
    st.text("O site é focado na apresentação de um laboratório que "
            ...
            "\nsuas quantidades, além disso, os usuários possuem suas proprias áreas"
            "\nde login e registro para acessar seu conteúdo."
            "\nPara estar funcional o site, é preciso que na empresa se tenha secretária, "
            "\npesquisadores e logo, o predisente. "
            "\nPara separarmos cada tipo de usuário logado, foi criada uma interface para "
            "\nespecifica-los em cada tipo de login. Em si, todos possuem caixas para cadastrar.")
